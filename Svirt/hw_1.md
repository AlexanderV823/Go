...
1. Можно выбрать следующие ОС: Ubuntu , CentOS, Debian, Fedora, VyOS, Oracle Linux. Всего в списке 74 различных версий ОС.
...
1. Предусмотрен доступ по SSH и OS Login.
2. Больше стоимость будет взыматься за выбор SSD диска большого объема, максимального количества ядер и доли их гарантированного использования, максимального количества оперативной памяти, отключения опции прерывания ВМ, выбор публичного IP и т.д.
