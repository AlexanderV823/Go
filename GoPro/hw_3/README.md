...
| **POST**   | `/tasks`      | Создать новую задачу               | `{"title": "string"}`               |    `201`    |    `400`, `405`     | `GET, POST`               |
| **GET**    | `/tasks/{id}` | Получить задачу по идентификатору  | —                                   |    `200`    | `400`, `404`, `405` | `GET, PUT, DELETE`        |
| **PUT**    | `/tasks/{id}` | Обновить задачу целиком            | `{"title": "string", "done": bool}` |    `200`    | `400`, `404`, `405` | `GET, PUT, DELETE`        |
| **DELETE** | `/tasks/{id}` | Удалить задачу по идентификатору   | —                                   |    `204`    | `400`, `404`, `405` | `GET, PUT, DELETE`        |
